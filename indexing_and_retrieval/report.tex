...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.95\textwidth]{figures/word_frequency_comparison.png}
    \caption{Word Frequency Comparison: Top 30 words before (left) and after (right) preprocessing. The raw text is dominated by common stopwords, while preprocessed text reveals more meaningful terms.}
    \label{fig:word_freq}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Performance Comparison between Elasticsearch and SelfIndex: (Top-left) Latency comparison across different percentiles, (Top-right) Throughput comparison, (Bottom-left) Speedup factors, (Bottom-right) Summary table of key metrics.}
